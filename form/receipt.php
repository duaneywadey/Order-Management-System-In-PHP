  ...
  <div class="container">
    <a class="navbar-brand" href="../index.php">Pero Pero Cusine</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
          ...
          <a href="../sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-primary">Register your restaurant! <i class="fas fa-arrow-circle-right"></i></button></a>
          </form>
        </div>
      </div>
</nav>
